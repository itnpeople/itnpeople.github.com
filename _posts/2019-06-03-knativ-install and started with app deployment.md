...
description: "Knativ는 AWS의 람다(Lambda)나, Google의 펑션(Function) 같은 Serverless 서비스를 할 수 있도록 워크로드를 구축 및 관리하는 Kubernetes 기반 오픈소스 플랫폼이다. Knative 의 개념 및 동작원리를 확인하기 위해 minikuke를 활용해 로컬에 설치해보고 샘플 앱을 배포 및 실행 해보고자 한다."
---
...
Knativ는 AWS의 람다(Lambda)나, Google의 펑션(Function) 같은 Serverless 서비스를 할 수 있도록 워크로드를 구축 및 관리하는 Kubernetes 기반 오픈소스 플랫폼이다. Knative 의 개념 및 동작원리를 확인하기 위해 minikuke를 활용해 로컬에 설치해보고 샘플 앱을 배포 및 실행 해보고자 한다.
