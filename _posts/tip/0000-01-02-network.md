...
* [NAT](#nat)
  * [`iptable`](#iptable)
  * [NAT use cases](#nat-use-cases)
* [Packet dump `tcpdump`](#packet-dump-tcpdump)
...
* (에) 111.222.33.44, 111.222.33.* 들어오는 네트워크 요청에 대해 nic eth0 로 응답
